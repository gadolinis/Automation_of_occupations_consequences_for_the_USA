...
In the charts below you can see the most sensitive and most robust occupations for automation.
...
I take lost jobs positions, when job automation probability is equal to 0.7 or higher (threshold >= 0.7).
